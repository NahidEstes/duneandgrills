...
const matrix = {
  ...
  [ROLES.ACCOUNTANT]: [CAPABILITIES.FINANCE_READ, CAPABILITIES.FINANCE_WRITE, CAPABILITIES.REFUNDS_READ, CAPABILITIES.REFUNDS_PROCESS, CAPABILITIES.INVENTORY_READ, CAPABILITIES.PAYABLES_READ, CAPABILITIES.PAYABLES_WRITE, CAPABILITIES.SUPPLIER_PAYMENT_RECORD],
  [ROLES.CUSTOMER]: [],
};
